            ...
            if($categories->rowCount() > 0){
                while($fetch_categories = $categories->fetch(PDO::FETCH_ASSOC)){
                    ?>
                            ...
                            <a href="category.php?category=<?= $fetch_categories['CategoryName']; ?>" class="swiper-slide slide bg-neutral-200 flex flex-col items-center justify-center hover:scale-110 transition-all rounded-lg"> 
